# -*- coding: utf-8 -*-
"""Copy of Final_ALLAM_App.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1ftE6yHfmlXHvZCEfPTN8NFJrUPfF4hNG
    ...
    <main>
        <section class="intro">
            ...
            <div class="poem-container">
                <img src="https://drive.google.com/thumbnail?id=1DUy3e_vURHBb779ZYUnReSGjaM6lqsXM" alt="Poem Background" class="poem-bg">
...
<body>
    ...
    <div class="main-container">
        ...
        <div class="chat-container">
            <h3>تحدث مع علّام لإكمال الأبيات الشعرية</h3>
...
h3 {
    font-size: 24px;
    margin: 0;
    margin-right: 5px; /* Space between h1 and logo2 */
}
...
function appendMessage(message, role) {
    ...
    if (role === 'bot') {
        ...
        messageDiv.innerHTML = message; // Just set message content for user
    }
...
<body>
    ...
    <div class="main-container">
        ...
        <div class="chat-container">
            <h3>تحدث مع علّام للحصول على أبيات شعرية لموضوع معين</h3>
            <div id="chat-log" class="chat-box"></div>
            <form id="chat-form">
...
<body>
    ...
    <div class="main-container">
        ...
        <div class="chat-container">
            <h3>تحدث مع علّام واحصل على الإجابات الشعرية</h3>
            <div id="chat-log" class="chat-box"></div>
            <form id="chat-form">
...
#WX_API_KEY = os.getenv("fHztnGejBHtoo16MWv0td8XeUwf5SG0MxhtLclkqxsvX")
#

WX_PROJECT_ID= ""     # please write your project ID
#2e562e8c-2fa4-4ba6-9bda-15f1677bd44f
#IBM_CLOUD_URL = os.getenv("IBM_CLOUD_URL")

CREDENTIALS = {
    "url": "https://eu-de.ml.cloud.ibm.com",
    "apikey": ""  # please write your API KEy
}
...
def chat1():
    ...
    #conversation_context = "</s><s>".join(conversation_log)
    conversation_context = "".join(conversation_log)
    input_prompt = PROMPT1.format(question=conversation_context )
    print(input_prompt)

    # Check if the word limit is reached
    if count_words(input_prompt) >= 300:
        conversation_log = []
        print("System: Conversation history has been reset due to word limit.")
        # Reset the conversation history and notify the user
        #conversation_log = f"</s><s>System: Conversation history has been reset due to word limit."
        # Create input_prompt
        #input_prompt = PROMPT1.format(question=conversation_log)
    ...
    def event_stream1(prompt):
        ...
        #session['conversation'].append(f"Response: {generated_text}")

        # Append the generated response to the conversation log
        #conversation_log.append(generated_text)
...
def chat2():
    ...
    input_prompt = PROMPT2.format(question=conversation_context)
    print(input_prompt)
...
def chat3():
    ...
    input_prompt = PROMPT3.format(question=conversation_context)
    print(input_prompt)
